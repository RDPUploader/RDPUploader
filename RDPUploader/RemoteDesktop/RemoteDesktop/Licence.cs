...
namespace RemoteDesktop
{
    internal class Licence
    {
        ...
        internal static void generate_keys(byte[] client_key, byte[] server_key, byte[] client_rsa)
        {
            ...
            Array.Copy(sourceArray, 0, RDPClient.m_Licence_Sign_Key, 0, 0x10);
            RDPClient.m_LicenceKey = Sign.hash16(sourceArray, client_key, server_key, 0x10);
        }
