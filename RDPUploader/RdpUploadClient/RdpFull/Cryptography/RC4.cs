...
namespace RdpUploadClient
{
    internal class RC4
    {
        private static readonly int BLOCK_SIZE = 1;
        ...
        public void crypt(byte[] inData, int inOffset, int length, byte[] outData, int outOffset)
        {
            this.engineUpdate(inData, inOffset, length, outData, outOffset);
        }
